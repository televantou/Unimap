...
import com.eir.unimap.sparql.SparqlSpecificRoomActivity;
...
public class SpecificRoom extends FragmentActivity implements LocationListener {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.activity_specific_room);
			  Intent intent1 = getIntent();
		       message = intent1.getStringExtra(RoomDirections.EXTRA_MESSAGE3);
		       List<String> results = new SparqlSpecificRoomActivity().queryRemoteSparqlEndpoint();
...
public void saveLocationOnClick2(View VIEW) {
	 locationManager.requestLocationUpdates( provider, 0, 0, this);
	 Location location = locationManager.getLastKnownLocation(provider);
	 if (location == null) {
         lat = 50.936291;
