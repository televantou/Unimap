...
public class Directions extends FragmentActivity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
	      ...
	      message = intent1.getStringExtra(Building.EXTRA_MESSAGE);
	      
	     
	       	List<String> results = new SparqlDirectionsActivity().queryRemoteSparqlEndpoint();
...
//	        else{
//       		 Toast.makeText(this, "The building you have requested does not exist",
//	                      Toast.LENGTH_LONG).show();
//       	}
